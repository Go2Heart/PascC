...
_lr_productions = [
  ...
  ('variable_list -> variable_list COMMA variable','variable_list',3,'p_variable_list','pparser.py',230),
  ('variable_list -> variable','variable_list',1,'p_variable_list','pparser.py',231),
  ('variable -> ID id_varpart','variable',2,'p_variable','pparser.py',238),
  ('id_varpart -> LBRACK expression RBRACK','id_varpart',3,'p_id_varpart','pparser.py',245),
  ('id_varpart -> empty','id_varpart',1,'p_id_varpart','pparser.py',246),
  ('procedure_call -> ID','procedure_call',1,'p_procedure_call','pparser.py',251),
  ('procedure_call -> ID LPAREN expression_list RPAREN','procedure_call',4,'p_procedure_call','pparser.py',252),
  ('else_part -> ELSE statement','else_part',2,'p_else_part','pparser.py',259),
  ('else_part -> empty','else_part',1,'p_else_part','pparser.py',260),
  ('expression_list -> expression_list COMMA expression','expression_list',3,'p_expression_list','pparser.py',265),
  ('expression_list -> expression','expression_list',1,'p_expression_list','pparser.py',266),
  ('expression -> simple_expression RELOP simple_expression','expression',3,'p_expression','pparser.py',273),
  ('expression -> simple_expression EQU simple_expression','expression',3,'p_expression','pparser.py',274),
  ('expression -> simple_expression','expression',1,'p_expression','pparser.py',275),
  ('simple_expression -> simple_expression ADDOP term','simple_expression',3,'p_simple_expression','pparser.py',282),
  ('simple_expression -> term','simple_expression',1,'p_simple_expression','pparser.py',283),
  ('term -> term MULDIVANDOP factor','term',3,'p_term','pparser.py',290),
  ('term -> factor','term',1,'p_term','pparser.py',291),
  ('factor -> number','factor',1,'p_factor','pparser.py',298),
  ('factor -> variable','factor',1,'p_factor','pparser.py',299),
  ('factor -> ID LPAREN expression_list RPAREN','factor',4,'p_factor','pparser.py',300),
  ('factor -> NOTOP factor','factor',2,'p_factor','pparser.py',301),
  ('factor -> ADDOP factor','factor',2,'p_factor','pparser.py',302),
  ('number -> ICONST','number',1,'p_number','pparser.py',311),
  ('number -> RCONST','number',1,'p_number','pparser.py',312),
  ('empty -> <empty>','empty',0,'p_empty','pparser.py',316),
]
